...
export async function POST(request: NextRequest): Promise<NextResponse<StepDataResponse>> {
  try {
    ...
    console.log(`💰 Rewarding user: ${stepCount} steps = ${reward.stepCoins} StepCoins`);
 ...
 */
function calculateStepCoinReward(stepCount: number): { stepCoins: number; multiplier: number } {
